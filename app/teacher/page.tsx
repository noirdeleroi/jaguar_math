...
export default async function TeacherDashboard() {
  ...
  const [{ data: classes }, { data: memberships }, { count: students }, { count: assignments }, gmailSendEnabled] = await Promise.all([
