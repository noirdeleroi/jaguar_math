...
type Props = { nickname: string; email: string | null; classes: string[]; assignments: DashboardAssignment[]; satSummary: SatSummary; currentWeek: CurrentWeek | null };
...
export default function StudentDashboard({ nickname, email, classes, assignments, satSummary, currentWeek }: Props) {
