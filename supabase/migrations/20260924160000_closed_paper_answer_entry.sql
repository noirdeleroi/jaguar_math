-- Teachers still need to transcribe printed answer sheets after closing a
-- Paper test. Keep student work locked while allowing the owning teacher's
-- dedicated answer-entry RPC to prepare and score an assigned student's sheet.
...
begin
  ...
  where id = p_assignment_id
    ...
    and (status = 'closed' or questions_released_at is not null);
