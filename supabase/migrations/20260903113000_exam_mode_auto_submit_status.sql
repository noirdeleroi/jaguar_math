-- Preserve the strict limit from the preceding migration while reporting an
-- already-finished attempt as auto-submitted only when its audit trail proves
-- that it was auto-submitted rather than manually submitted.
